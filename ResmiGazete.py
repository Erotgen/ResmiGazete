...
def Result(text, word_real):
    ...
    if index == -1:
        ...
        index = text_little.find(word1[0:len(word1)-1])
        print(index)

        if index == -1 and " " in word_real:

            place = word.find(" ")
            name = word[0:place]
            surname = word[place+1:]
            word = name+"\n"+surname

            index = text_little.find(word)
            print(index)

            # Newline + Boşluk Karakterli Normal Arama
            if index == -1:
                word = name+"\n "+surname
                index = text_little.find(word)
                print(index)

                # Boşluk + Newline Karakterli Normal Arama
                if index == -1:
                    word = name+" \n"+surname
                    index = text_little.find(word)
                    print(index)

                    # Newline Karakterli Ayrık Arama
                    if index == -1:
                        length = (len(name))*2
                        name1 = word1[0:length]
                        surname1 = word1[length+2:]
                        word1 = name1[0:len(name1)-1]+"\n" + surname1[0:len(surname1)-1]
                        index = text_little.find(word1)
                        print(index)

                        # Newline + Boşluk Karakterli Ayrık Arama
                        if index == -1:
                            word1 = name1[0:len(name1)-1] +"\n "+surname1[0:len(surname1)-1]
                            index = text_little.find(word1)
                            print(index)

                            # Boşluk + Newline Karakterli Ayrık Arama
                            if index == -1:
                                word1 = name1[0:len(name1)-1] +" \n"+surname1[0:len(surname1)-1]
                                index = text_little.find(word1)
                                print(index)

                                # Tab Karakterli Normal Arama
                                if index == -1:
                                    word = name+"\t"+surname
                                    index = text_little.find(word)
                                    print(index)

                                    # Tab + Boşluk Karakterli Normal Arama
                                    if index == -1:
                                        word = name+"\t "+surname
                                        index = text_little.find(word)
                                        print(index)

                                        # Boşluk + Tab Karakterli Normal Arama
                                        if index == -1:
                                            word = name+" \t"+surname
                                            index = text_little.find(word)
                                            print(index)

                                            # Tab Karakterli Ayrık Arama
                                            if index == -1:
                                                word1 = name1[0:len(name1)-1]+"\t"+surname1[0:len(surname1)-1]
                                                index = text_little.find(word1)
                                                print(index)

                                                # Tab + Boşluk Karakterli Ayrık Arama
                                                if index == -1:
                                                    word1 = name1[0:len(name1)-1]+"\t "+surname1[0:len(surname1)-1]
                                                    index = text_little.find(word1)
                                                    print(index)

                                                    # Boşluk + Tab Karakterli Ayrık Arama
                                                    if index == -1:
                                                        word1 = name1[0:len(name1)-1]+" \t"+surname1[0:len(surname1)-1]
                                                        index = text_little.find(word1)
                                                        print(index)

                                                        # Normal İsim Ayrık Soyisim Arama
                                                        if index == -1:
                                                            word1 = name+" " +surname1[0:len(surname1)-1]
                                                            index = text_little.find(word1)
                                                            print(index)

                                                            # New Line Karakterli Normal İsim Ayrık Soyisim Arama
                                                            if index == -1:
                                                                word1 = name+"\n" +surname1[0:len(surname1)-1]
                                                                index = text_little.find(word1)
                                                                print(index)

                                                                # Newline + Boşluk Karakterli Normal İsim Ayrık Soyisim Arama
                                                                if index == -1:
                                                                    word1 = name+"\n " +surname1[0:len(surname1)-1]
                                                                    index = text_little.find(word1)
                                                                    print(index)

                                                                    # Boşluk + Newline Karakterli Normal İsim Ayrık Soyisim Arama
                                                                    if index == -1:
                                                                        word1 = name+" \n" +surname1[0:len(surname1)-1]
                                                                        index = text_little.find(word1)
                                                                        print(index)

                                                                        # Tab Karakterli Normal İsim Ayrık Soyisim Arama
                                                                        if index == -1:
                                                                            word1 = name+"\t" +surname1[0:len(surname1)-1]
                                                                            index = text_little.find(word1)
                                                                            print(index)

                                                                            # Tab + Boşluk Karakterli Normal İsim Ayrık Soyisim Arama
                                                                            if index == -1:
                                                                                word1 = name+"\t " +surname1[0:len(surname1)-1]
                                                                                index = text_little.find(word1)
                                                                                print(index)

                                                                                # Boşluk + Tab Karakterli Normal İsim Ayrık Soyisim Arama
                                                                                if index == -1:
                                                                                    word1 = name+" \t" +surname1[0:len(surname1)-1]
                                                                                    index = text_little.find(word1)
                                                                                    print(index)

                                                                                    # Ayrık İsim Normal Soyisim Arama
                                                                                    if index == -1:
                                                                                        word1 = name1[0:len(name1)-1]+" "+surname
                                                                                        index = text_little.find(word1)
                                                                                        print(index)

                                                                                        # Newline Karakterli Ayrık İsim Normal Soyisim Arama
                                                                                        if index == -1:
                                                                                            word1 = name1[0:len(name1)-1]+"\n"+surname
                                                                                            index = text_little.find(word1)
                                                                                            print(index)

                                                                                            # Newline + Boşluk Karakterli Ayrık İsim Normal Soyisim Arama
                                                                                            if index == -1:
                                                                                                word1 = name1[0:len(name1)-1]+"\n "+surname
                                                                                                index = text_little.find(word1)
                                                                                                print(index)

                                                                                                # Boşluk + Newline Karakterli Ayrık İsim Normal Soyisim Arama
                                                                                                if index == -1:
                                                                                                    word1 = name1[0:len(name1)-1]+" \n"+surname
                                                                                                    index = text_little.find(word1)
                                                                                                    print(index)

                                                                                                    # Tab Karakterli Ayrık İsim Normal Soyisim Arama
                                                                                                    if index == -1:
                                                                                                        word1 = name1[0:len(name1)-1]+"\t"+surname
                                                                                                        index = text_little.find(word1)
                                                                                                        print(index)

                                                                                                        # Tab + Boşluk Karakterli Ayrık İsim Normal Soyisim Arama
                                                                                                        if index == -1:
                                                                                                            word1 = name1[0:len(name1)-1]+"\t "+surname
                                                                                                            index = text_little.find(word1)
                                                                                                            print(index)

                                                                                                            # Boşluk + Tab Karakterli Ayrık İsim Normal Soyisim Arama
                                                                                                            if index == -1:
                                                                                                                word1 = name1[0:len(name1)-1]+" \t"+surname
                                                                                                                index = text_little.find(word1)
                                                                                                                print(index)
                                                                                                                ...
                                                                                                                # Normal Döngü
                                                                                                                if index == -1:
                                                                                                                    average = math.ceil(len(surname)/2)
                                                                                                                    word2 = ""
                                                                                                                    for i in range(average):
                                                                                                                        word2 = name+" " +surname[0:len(surname)-i]
                                                                                                                        index = text_little.find(word2)
                                                                                                                        if index != -1:
                                                                                                                            break
                                                                                                                    print(index)
                                                                                                                    ...
                                                                                                                    # Ayrık Döngü
                                                                                                                    if index == -1:
                                                                                                                        average = math.ceil(len(surname1)/2)
                                                                                                                        word2 = ""
                                                                                                                        for i in range(average):
                                                                                                                            word2 = name+" " +surname1[0:len(surname1)-i]
                                                                                                                            index = text_little.find(word2)
                                                                                                                            if index != -1:
                                                                                                                                break
                                                                                                                        print(index)

                                                                                                                        # Ayrık isim Normal Döngü
                                                                                                                        if index == -1:
                                                                                                                            average = math.ceil(len(surname)/2)
                                                                                                                            word2 = ""
                                                                                                                            for i in range(average):
                                                                                                                                word2 = name1+" " +surname[0:len(surname)-i]
                                                                                                                                index = text_little.find(word2)
                                                                                                                                if index != -1:
                                                                                                                                    break
                                                                                                                            print(index)

                                                                                                                            # Ayrık isim Ayrık Döngü
                                                                                                                            if index == -1:
                                                                                                                                average = math.ceil(len(surname1)/2)
                                                                                                                                word2 = ""
                                                                                                                                for i in range(average):
